...
#    define MINDGROVE_CONSOLE_BASE        UART_REG(0)
...
#    define MINDGROVE_CONSOLE_TX          GPIO_UART0_TX
...
static struct up_dev_s g_uart0priv =
{
  ...
  .irq       = ((MINDGROVE_PLIC_START)+(UART0_IRQn)),
};
...
static struct up_dev_s g_uart1priv =
{
  ...
  .irq       = ((MINDGROVE_PLIC_START)+(UART1_IRQn)),
};
...
static struct up_dev_s g_uart2priv =
{
  ...
  .irq       = ((MINDGROVE_PLIC_START)+(UART2_IRQn)),
};
...
static struct up_dev_s g_uart3priv =
{
  ...
  .irq       = ((MINDGROVE_PLIC_START)+(UART3_IRQn)),
};
...
static struct up_dev_s g_uart4priv =
{
  ...
  .irq       = ((MINDGROVE_PLIC_START)+(UART4_IRQn)),
};
...
static void up_restoreuartint(struct up_dev_s *priv, uint8_t im)
{
  ...
  putreg16(im, priv->uartbase + UART_EV_ENABLE_OFFSET);
...
static void up_send(struct uart_dev_s *dev, int ch)
{
  ...
  putreg8((uint8_t)ch,priv->uartbase+UART_TX_OFFSET);
}
